...
function initParallaxEffect() {
  ...
  var parallaxItemsCol = [{
    className: _utils_classNames__WEBPACK_IMPORTED_MODULE_0__.classNames.parallax[0],
    duration: 0.7,
    toggleActions: 'top 90%'
  }, {
    className: _utils_classNames__WEBPACK_IMPORTED_MODULE_0__.classNames.parallax[1],
    duration: 1,
    toggleActions: 'top 90%'
  }, {
    className: _utils_classNames__WEBPACK_IMPORTED_MODULE_0__.classNames.parallax[2],
    duration: 0.5,
    toggleActions: 'top center'
  }, {
    className: _utils_classNames__WEBPACK_IMPORTED_MODULE_0__.classNames.parallax[3],
    duration: 0.8,
    toggleActions: 'top 90%'
  }, {
    className: _utils_classNames__WEBPACK_IMPORTED_MODULE_0__.classNames.parallax[4],
    duration: 0.6,
    toggleActions: 'top 90%'
  }];
  parallaxItemsCol.forEach(function (_ref) {
    var className = _ref.className,
      toggleActions = _ref.toggleActions;
    gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(".".concat(className), {
      scrollTrigger: {
        trigger: ".".concat(className),
        start: toggleActions,
...
function toggleMenu() {
  var classMenu = _utils_classNames__WEBPACK_IMPORTED_MODULE_0__.classNames.burgerMenu.menu;
  var classMenuActive = _utils_classNames__WEBPACK_IMPORTED_MODULE_0__.classNames.burgerMenu.menuActive;
  var classOpenBtn = _utils_classNames__WEBPACK_IMPORTED_MODULE_0__.classNames.burgerMenu.open;
  var classCloseBtn = _utils_classNames__WEBPACK_IMPORTED_MODULE_0__.classNames.burgerMenu.close;
  var menu = document.querySelector(".".concat(classMenu));
  var openBtn = document.querySelector(".".concat(classOpenBtn));
  var closeBtn = menu.querySelector(".".concat(classCloseBtn));
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "activateNavLink": () => (/* binding */ activateNavLink)
/* harmony export */ });
/* harmony import */ var _utils_classNames__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/classNames */ "./src/scripts/utils/classNames.js");

function activateNavLink() {
  var classNavLink = _utils_classNames__WEBPACK_IMPORTED_MODULE_0__.classNames.nav.link;
  var classActiveNavLink = _utils_classNames__WEBPACK_IMPORTED_MODULE_0__.classNames.nav.activeLink;
  var navLinks = document.querySelectorAll(".".concat(classNavLink));
  function handleClick(e) {
    var currentActive = document.querySelector(".".concat(classActiveNavLink));
    if (currentActive) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "closePopupOnClick": () => (/* binding */ closePopupOnClick),
/* harmony export */   "initImagePopup": () => (/* binding */ initImagePopup)
/* harmony export */ });
/* harmony import */ var _utils_classNames__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/classNames */ "./src/scripts/utils/classNames.js");

function closePopupOnClick() {
  var classOverlay = _utils_classNames__WEBPACK_IMPORTED_MODULE_0__.classNames.popups.overlay.block;
  var classOverlayActive = _utils_classNames__WEBPACK_IMPORTED_MODULE_0__.classNames.popups.overlay.blockActive;
  var classPopup = _utils_classNames__WEBPACK_IMPORTED_MODULE_0__.classNames.popups.popup.block;
  var classPopupActive = _utils_classNames__WEBPACK_IMPORTED_MODULE_0__.classNames.popups.popup.blockActive;
  var overlay = document.querySelector(".".concat(classOverlay));
  overlay.addEventListener('click', function (e) {
    if (overlay !== e.target) return;
    overlay.classList.remove(classOverlayActive);
    document.body.style.overflow = null;
    document.querySelectorAll(".".concat(classPopup)).forEach(function (popup) {
...
function initImagePopup() {
  var classZoomPopup = _utils_classNames__WEBPACK_IMPORTED_MODULE_0__.classNames.popups.zoom.block;
  var classZoomImg = _utils_classNames__WEBPACK_IMPORTED_MODULE_0__.classNames.popups.zoom.img;
  var zoomPopup = document.querySelector(".".concat(classZoomPopup));
  var zoomImg = zoomPopup.querySelector(".".concat(classZoomImg));
  document.querySelectorAll(".".concat(_utils_classNames__WEBPACK_IMPORTED_MODULE_0__.classNames.zoom)).forEach(function (zoomBtn) {
...
/***/ "./src/scripts/modules/scrollToggle.js":
/*!*********************************************!*\
  !*** ./src/scripts/modules/scrollToggle.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "toggleFixedOnScroll": () => (/* binding */ toggleFixedOnScroll)
/* harmony export */ });
/* harmony import */ var _utils_classNames__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/classNames */ "./src/scripts/utils/classNames.js");

function toggleFixedOnScroll() {
  var classFixed = _utils_classNames__WEBPACK_IMPORTED_MODULE_0__.classNames.fixed.block;
  var classFixedActive = _utils_classNames__WEBPACK_IMPORTED_MODULE_0__.classNames.fixed.active;
  var classDependent = _utils_classNames__WEBPACK_IMPORTED_MODULE_0__.classNames.fixed.dependent;
  var fixedEl = document.querySelector(".".concat(classFixed));
  var dependentEl = document.querySelector(".".concat(classDependent));
  document.addEventListener('scroll', function () {
    var dependentBottom = dependentEl.getBoundingClientRect().bottom;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "initInnovationSlider": () => (/* binding */ initInnovationSlider),
/* harmony export */   "initPresentationSlider": () => (/* binding */ initPresentationSlider),
/* harmony export */   "initResonsSlider": () => (/* binding */ initResonsSlider),
/* harmony export */   "initReviewsSlider": () => (/* binding */ initReviewsSlider)
/* harmony export */ });
/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper */ "./node_modules/swiper/swiper.esm.js");
/* harmony import */ var _utils_classNames__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/classNames */ "./src/scripts/utils/classNames.js");
/* harmony import */ var _utils_breakpoints__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/breakpoints */ "./src/scripts/utils/breakpoints.js");
...
function initInnovationSlider() {
  var sliderClass = _utils_classNames__WEBPACK_IMPORTED_MODULE_1__.classNames.slider.innovation.slider;
  var sliderPrevClass = _utils_classNames__WEBPACK_IMPORTED_MODULE_1__.classNames.slider.innovation.btnPrev;
  var sliderNextClass = _utils_classNames__WEBPACK_IMPORTED_MODULE_1__.classNames.slider.innovation.btnNext;
  return new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".".concat(sliderClass), {
    modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation],
    navigation: {
      prevEl: ".".concat(sliderPrevClass),
      nextEl: ".".concat(sliderNextClass)
    },
    slidesPerView: 1,
    spaceBetween: 20,
    speed: 1000,
...
function initPresentationSlider() {
  var _breakpoints;
  var sliderClass = _utils_classNames__WEBPACK_IMPORTED_MODULE_1__.classNames.slider.presentation;
  return new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".".concat(sliderClass), {
    ...
    centeredSlides: true,
    keyboard: true,
    breakpoints: (_breakpoints = {}, _defineProperty(_breakpoints, _utils_breakpoints__WEBPACK_IMPORTED_MODULE_2__.breakpointsMin.lg, {
      slidesPerView: 1.5
    }), _defineProperty(_breakpoints, _utils_breakpoints__WEBPACK_IMPORTED_MODULE_2__.breakpointsMin.xl, {
      slidesPerView: 2
    }), _breakpoints)
  });
}
function initResonsSlider() {
  var sliderClass = _utils_classNames__WEBPACK_IMPORTED_MODULE_1__.classNames.slider.resons.slider;
  var sliderPrevClass = _utils_classNames__WEBPACK_IMPORTED_MODULE_1__.classNames.slider.resons.btnPrev;
  var sliderNextClass = _utils_classNames__WEBPACK_IMPORTED_MODULE_1__.classNames.slider.resons.btnNext;
  var sliderScrollbarClass = _utils_classNames__WEBPACK_IMPORTED_MODULE_1__.classNames.slider.resons.scrollbar;
  var sliderScrollbarDragClass = _utils_classNames__WEBPACK_IMPORTED_MODULE_1__.classNames.slider.resons.scrollbarDrag;
  return new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".".concat(sliderClass), {
    ...
    scrollbar: {
      el: ".".concat(sliderScrollbarClass),
    ...
    keyboard: true,
    rewind: true,
    breakpoints: _defineProperty({}, _utils_breakpoints__WEBPACK_IMPORTED_MODULE_2__.breakpointsMin.md, {
      slidesPerView: 2
    })
  });
}
function initReviewsSlider() {
  var _breakpoints3;
  var classSwiper = _utils_classNames__WEBPACK_IMPORTED_MODULE_1__.classNames.slider.testimonials.slider;
  return new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".".concat(classSwiper), {
    modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation],
    navigation: {
      prevEl: ".".concat(_utils_classNames__WEBPACK_IMPORTED_MODULE_1__.classNames.slider.testimonials.btnPrev),
      nextEl: ".".concat(_utils_classNames__WEBPACK_IMPORTED_MODULE_1__.classNames.slider.testimonials.btnNext)
    },
    slidesPerView: 1,
    spaceBetween: 40,
    speed: 1000,
    rewind: true,
    breakpoints: (_breakpoints3 = {}, _defineProperty(_breakpoints3, _utils_breakpoints__WEBPACK_IMPORTED_MODULE_2__.breakpointsMin.md, {
      slidesPerView: 1.072
    }), _defineProperty(_breakpoints3, _utils_breakpoints__WEBPACK_IMPORTED_MODULE_2__.breakpointsMin.xl, {
      slidesPerView: 2.11
    }), _breakpoints3)
  });
}
...
function initTabs() {
  var classBtn = _utils_classNames__WEBPACK_IMPORTED_MODULE_0__.classNames.tabs.visuals.btn;
  var classBtnActive = _utils_classNames__WEBPACK_IMPORTED_MODULE_0__.classNames.tabs.visuals.btnActive;
  var classBtnMobile = _utils_classNames__WEBPACK_IMPORTED_MODULE_0__.classNames.tabs.visuals.btnMobile;
  var classTab = _utils_classNames__WEBPACK_IMPORTED_MODULE_0__.classNames.tabs.visuals.tab;
  var classTabActive = _utils_classNames__WEBPACK_IMPORTED_MODULE_0__.classNames.tabs.visuals.tabActive;
  function tabHandler(e) {
    document.querySelectorAll(".".concat(classBtnActive)).forEach(function (oldBtn) {
      oldBtn.classList.remove(classBtnActive);
    });
    document.querySelectorAll(".".concat(classTabActive)).forEach(function (oldTab) {
      oldTab.classList.remove(classTabActive);
    });
    var currentTabIdx = e.currentTarget.dataset.tab;
    var currentBtn = document.querySelector(".".concat(classBtn, "[data-tab=\"").concat(currentTabIdx, "\"]"));
    var currentTab = document.querySelector(".".concat(classTab, "[data-tab=\"").concat(currentTabIdx, "\"]"));
    currentBtn.classList.add(classBtnActive);
    currentTab.classList.add(classTabActive);
  }
  document.querySelectorAll(".".concat(classBtnMobile)).forEach(function (btnMobile) {
    btnMobile.addEventListener('click', tabHandler);
  });
  document.querySelectorAll(".".concat(classBtn)).forEach(function (btn, idx) {
...
/***/ "./src/scripts/utils/breakpoints.js":
/*!******************************************!*\
  !*** ./src/scripts/utils/breakpoints.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "breakpointsMax": () => (/* binding */ breakpointsMax),
/* harmony export */   "breakpointsMin": () => (/* binding */ breakpointsMin)
/* harmony export */ });
var breakpointsMin = {
  xxl: 1440,
  xl: 1200,
...
var classNames = {
  ...
  parallax: ['guide__bg-wrap_1', 'guide__bg-wrap_2', 'guide__bg-wrap_3', 'guide__bg-wrap_4', 'guide__bg-wrap_5']
};
...
/* harmony import */ var handy_collapse__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! handy-collapse */ "./node_modules/handy-collapse/dist/handy-collapse.mjs");
/* harmony import */ var _vendor_headerBehavior__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vendor/headerBehavior */ "./src/scripts/vendor/headerBehavior.js");
/* harmony import */ var _vendor_select_Select__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./vendor/select/Select */ "./src/scripts/vendor/select/Select.js");
...
/* harmony import */ var _modules_sliders__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/sliders */ "./src/scripts/modules/sliders.js");
/* harmony import */ var _modules_popups__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/popups */ "./src/scripts/modules/popups.js");
...
/* harmony import */ var _modules_scrollToggle__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/scrollToggle */ "./src/scripts/modules/scrollToggle.js");
/* harmony import */ var _modules_gsap__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/gsap */ "./src/scripts/modules/gsap.js");
/* harmony import */ var _modules_navigation__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/navigation */ "./src/scripts/modules/navigation.js");
...
(0,_vendor_headerBehavior__WEBPACK_IMPORTED_MODULE_2__.updateHeaderOnScroll)(); // Header
(0,_modules_menu__WEBPACK_IMPORTED_MODULE_4__.toggleMenu)(); // Menu

// Navigation
(0,_modules_navigation__WEBPACK_IMPORTED_MODULE_10__.activateNavLink)();

// Select
new _vendor_select_Select__WEBPACK_IMPORTED_MODULE_3__.Select('.select'); // eslint-disable-line

// Accordion
new handy_collapse__WEBPACK_IMPORTED_MODULE_1__["default"](); // eslint-disable-line

// Sliders
(0,_modules_sliders__WEBPACK_IMPORTED_MODULE_5__.initInnovationSlider)();
(0,_modules_sliders__WEBPACK_IMPORTED_MODULE_5__.initPresentationSlider)();
(0,_modules_sliders__WEBPACK_IMPORTED_MODULE_5__.initResonsSlider)();
(0,_modules_sliders__WEBPACK_IMPORTED_MODULE_5__.initReviewsSlider)();

// Modal Image
(0,_modules_popups__WEBPACK_IMPORTED_MODULE_6__.closePopupOnClick)();
(0,_modules_popups__WEBPACK_IMPORTED_MODULE_6__.initImagePopup)();

// Tabs
(0,_modules_tabs__WEBPACK_IMPORTED_MODULE_7__.initTabs)();

// Scroll Toggle
(0,_modules_scrollToggle__WEBPACK_IMPORTED_MODULE_8__.toggleFixedOnScroll)();

// Parallax Effect
(0,_modules_gsap__WEBPACK_IMPORTED_MODULE_9__.initParallaxEffect)();
})();
