...
function toggleMenu() {
  ...
  var classOpenBtn = classNames.burgerMenu.open;
...
function _defineProperty(obj, key, value) { key = sliders_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function sliders_toPropertyKey(arg) { var key = sliders_toPrimitive(arg, "string"); return sliders_typeof(key) === "symbol" ? key : String(key); }
function sliders_toPrimitive(input, hint) { if (sliders_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (sliders_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
...
function initInnovationSlider() {
  var sliderClass = classNames.slider.innovation.slider;
  var sliderPrevClass = classNames.slider.innovation.btnPrev;
  var sliderNextClass = classNames.slider.innovation.btnNext;
...
function initPresentationSlider() {
  var _breakpoints;
  var sliderClass = classNames.slider.presentation;
  return new core(".".concat(sliderClass), {
    modules: [Autoplay],
    autoplay: {
      delay: 5000
    ...
    centeredSlides: true,
    keyboard: true,
    breakpoints: (_breakpoints = {}, _defineProperty(_breakpoints, breakpointsMin.lg, {
      slidesPerView: 1.5
...
function initResonsSlider() {
  var sliderClass = classNames.slider.resons.slider;
  var sliderPrevClass = classNames.slider.resons.btnPrev;
  var sliderNextClass = classNames.slider.resons.btnNext;
  var sliderScrollbarClass = classNames.slider.resons.scrollbar;
  var sliderScrollbarDragClass = classNames.slider.resons.scrollbarDrag;
  return new core(".".concat(sliderClass), {
...
function initReviewsSlider() {
  var _breakpoints3;
  var classSwiper = classNames.slider.testimonials.slider;
  return new core(".".concat(classSwiper), {
    modules: [Navigation],
    navigation: {
      prevEl: ".".concat(classNames.slider.testimonials.btnPrev),
      nextEl: ".".concat(classNames.slider.testimonials.btnNext)
    },
    slidesPerView: 1,
    spaceBetween: 40,
    speed: 1000,
...
function closePopupOnClick() {
  var classOverlay = classNames.popups.overlay.block;
  var classOverlayActive = classNames.popups.overlay.blockActive;
  var classPopup = classNames.popups.popup.block;
  var classPopupActive = classNames.popups.popup.blockActive;
...
function initImagePopup() {
  var classZoomPopup = classNames.popups.zoom.block;
  var classZoomImg = classNames.popups.zoom.img;
  var zoomPopup = document.querySelector(".".concat(classZoomPopup));
  var zoomImg = zoomPopup.querySelector(".".concat(classZoomImg));
  document.querySelectorAll(".".concat(classNames.zoom)).forEach(function (zoomBtn) {
...
function initTabs() {
  var classBtn = classNames.tabs.visuals.btn;
  var classBtnActive = classNames.tabs.visuals.btnActive;
  var classBtnMobile = classNames.tabs.visuals.btnMobile;
  var classTab = classNames.tabs.visuals.tab;
  var classTabActive = classNames.tabs.visuals.tabActive;
...
;// CONCATENATED MODULE: ./src/scripts/modules/scrollToggle.js

function toggleFixedOnScroll() {
  var classFixed = classNames.fixed.block;
  var classFixedActive = classNames.fixed.active;
  var classDependent = classNames.fixed.dependent;
...
;// CONCATENATED MODULE: ./src/scripts/modules/gsap.js
...
function initParallaxEffect() {
  ...
  parallaxItemsCol.forEach(function (_ref) {
    ...
    gsapWithCSS.to(".".concat(className), {
      scrollTrigger: {
...
;// CONCATENATED MODULE: ./src/scripts/modules/navigation.js

function activateNavLink() {
  var classNavLink = classNames.nav.link;
  var classActiveNavLink = classNames.nav.activeLink;
